            ...
            <div id='content' className='mt-4'>
                <table className='table text-muted text-center'>
                    ...
                    <tbody>
                        ...
                        <tr style={{color: 'black'}}>
                            <td>
                            {window.web3.utils.fromWei(String(this.props.stakingBalances), 'ether')} USDT
                            </td>
                            <td>
                            {window.web3.utils.fromWei(String(this.props.rwdBalances), 'ether')} RWD
                            </td>
                    ...
                    <form 
                     ...
                     className='mb-3'>
                        <div style={{borderSpacing:'0 1em'}}>
                            ...
                            <label className='float-right' style={{marginRight:'15px'}}>
